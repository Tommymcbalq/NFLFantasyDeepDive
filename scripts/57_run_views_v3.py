...
ADP window 08-11->08-18, views_2026_v3.csv (31 views, 8 updated/new 2026-08-18)."""
...
views=pd.read_csv(R/"views_2026_v3.csv")
...
out.to_csv(R/"board_2026_v3_with_views.csv",index=False)
